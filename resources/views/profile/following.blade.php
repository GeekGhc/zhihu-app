...
@section('profile-content')
    <div class="profileMain-header">
        <ul class="profileMain-tabs">
            ...
            <li class="item"><a class="active" href="{{route('following',['userName'=>$user->name])}}">关注的人</a></li>
    ...
    <div class="profileMain-content">
        ...
        <div class="list-item">
            <div class="col-md-10">
               ...
               <a class="name" href="/people/{{$following->name}}">{{$following->name}}</a>
            </div>
            <div class="col-md-2">
               <div class="meta-info">{{$following->followers_count}}人关注</div>
            </div>
        </div>
        @endforeach
    </div>
