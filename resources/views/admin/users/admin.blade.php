            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="form-group">
                        ...
                        <input value="{{$user->name}}" required="required" type="text" class="form-control" name="name" autocomplete="off"
                               maxlength="80">
                    </div>
                    <div class="form-group">
                        <label>邮箱
                        ...
                        <input value="{{$user->email}}" required="required" type="text" class="form-control" name="email" autocomplete="off"
                               maxlength="80">
                    </div>
                </div>
